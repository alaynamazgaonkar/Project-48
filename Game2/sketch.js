...
var game=0;
var coins=0;
var s0=0,s1=4,s3=0,s4=0,s5=0,s6=0,s7=0,s8=0,s9=0,s10=0;
var s11=0,s12=0,s13=0,s14=0,s15=0,s16=0,s17=0,s18=0,s19=0,s20=0;
var s21=0,s22=0,s23=0,s24=0,s25=0, s27=0,s29=0,s30=0,s301=0;
var t1=0,t4=0,t7=0,t8=0,t9=0,t10=0,t11=0,t13=0,t14=0,t19=0,t25=0;
var t22=0,t23=0,t17=0,t18=0;
var npc7d=0;
var p=0,path=0;
var g=0,a1=0,a2=0,j1=0,j2=0,i=0,i2=0,k=0,gm=0,f=0,c3=false;
var q1=0,q2=0,q3=0,r=0,arr=5,d=0,v=0;
var cavepath="right",prince="alive",future="";
...
function preload(){
    ...
    img27=loadImage("i/cave.jpg")
    img28=loadImage("i/black.png")
    img29=loadImage("i/war.png")
    img30=loadImage("i/images.jpg")
 ...
 npc15img=loadImage("i/a2fe4d56021defc825d8fa8f7ccd1409.png")
  ...
  npc24img=loadImage("i/maid.png")
    ...
    rabbitimg=loadImage("i/rabbit.png")
    arrowimg=loadImage("i./arrow.png")
    bowimg=loadImage("i/bow.png")
    scrollimg=loadImage("i/unnamed.png")
...
function setup(){
    ...
    bg.addImage("bg4",img4)
     ...
     bg.addImage("bg27",img27)
     bg.addImage("bg28",img28)
     bg.addImage("bg29",img29)
     bg.scale=2.8

    table=createSprite(350,250,800,800)
    table.addImage("b",img30)
...
//     npc4.scale=0.6
     ...
     npc23.scale=0.32
     npc24=createSprite(480,320,70,150)
     npc24.addImage("n",npc24img)
     npc24.scale=0.32
     ...
     mc=createSprite(200,340,50,200)
     ...
     bow=createSprite(130,300,20,170)
     bow.addImage("b",bowimg)
     bow.scale=0.3
     arrow=createSprite(120,300,100,1)
     arrow.addImage("a",arrowimg)
     arrow.scale=0.12

     ra1=createSprite(600,700,10,10)
     ra1.addImage("r",rabbitimg)
     ra1.scale=0.015
     ra2=createSprite(600,1200,10,10)
     ra2.addImage("r",rabbitimg)
     ra2.scale=0.015
     ra3=createSprite(600,1700,10,10)
     ra3.addImage("r",rabbitimg)
     ra3.scale=0.015
     ra4=createSprite(600,2300,10,10)
     ra4.addImage("r",rabbitimg)
     ra4.scale=0.015
     ra5=createSprite(600,2800,10,10)
     ra5.addImage("r",rabbitimg)
     ra5.scale=0.015
    ...
    scroll0=createSprite(350,250,50,50)
scroll0.addImage("s",scrollimg)
scroll0.scale=1.5
}
function draw(){ 
if(game===0){
    ...
    move()
if(keyDown("b")){gamestate=27}
if(keyDown("v")){gamestate=32}
console.log(gamestate)
scroll0.visible=false
door1.visible=false
door2.visible=false
door3.visible=false
door4.visible=false
...
fill("black")
strokeWeight(1)
text("It wasn't long after they found out that the minister was",130,100)
text("giving out military information to the Four Kingdoms that",130,120)
text("Cordonia was attacked. You went away for a while after ",130,140)
text("your investigation was complete. When you heard about ",130,160)
text("the attack, you came back as fast as you could but you ",130,180)
text("were too late.",130,200)
text("(Get as many coins as you can along the way, it will help",130,260)
text("you in  the end. You can get coins by helping citizens)",130,280)
// text(" ",130,180)
// text(" ",130,180)
strokeWeight(3)
var op=createSprite(360,360,60,20)
    op.visible=false
    fill("yellow")
    text("Okay",340,365)
    if(mousePressedOver(op)){ s1=0}
    if(keyDown("p")){gamemode=1}
}
}
if(gamestate===2){
...
if(gamestate===4){ 
   ...
   npc10.visible=true  
    ...
    if(mc.x>670){gamestate=5
        mc.x=50
        s4=0} 
        if(mousePressedOver(npc10)&&s4===0){s4=1}
        textSize(18)
        fill("white") 
        stroke("black")
        strokeWeight(3)
...
if(gamestate===5){
    ...
    if(s5===1){
        ...
        bow.visible=true
        arrow.visible=true
        text("Arrows left:  "+arr ,10,50)
        fill("white")
        textSize(14)
       //ext("(click the bow to reload)",330,490)
        textSize(18)
        if(arr===0){text("(Arrows are over)",330,400)
         fill("yellow") 
       text("Okay",360,485)
      ...
      textSize(16)
     text("Get as many rabbits as you can. Shoot when they are near arrow level.",10,100)
     text("Press the space bar to release and click on the bow to respawn the arrow",10,120)
     text("Start",340,465)
      if(mousePressedOver(op)){s5=2
                                 t4=2
                                 ra1.velocityY=-4
                                 ra2.velocityY=-4
                                 ra3.velocityY=-4
    ...
    if(s5===2){ 
        ...
        // if(ra1.y===250){ra1.velocityY=7}
        // if(ra1.y===450){ra1.velocityY=-7}
        // if(ra5.y===250){ra5.velocityY=7}
        // if(ra5.y===450){ra5.velocityY=-7}
        // if(ra4.y===250){ra4.velocityY=7}
        // if(ra4.y===450){ra4.velocityY=-7}
        // if(ra3.y===250){ra3.velocityY=7}
        // if(ra3.y===450){ra3.velocityY=-7}
        // if(ra2.y===250){ra2.velocityY=7}
        // if(ra2.y===450){ra2.velocityY=-7}
                
        if(arrow.isTouching(ra1)){ra1.destroy()
                                 r=r+1}
        if(arrow.isTouching(ra2)){ra2.destroy()
                                 r=r+1}
        if(arrow.isTouching(ra3)){ra3.destroy()
                                 r=r+1}
        if(arrow.isTouching(ra4)){ra4.destroy()
                                 r=r+1}
        if(arrow.isTouching(ra5)){ra5.destroy()
                                 r=r+1}
...
text("I think you should explore the city for awhile, Come to me when you're ready to go to",10,420)
  ...
  if(mousePressedOver(op2)&&coins>99){gamestate=16
    ...
    if(c3===true){
        ...
        op2.visible=false
        if(mousePressedOver(op1)){s8=0}
        if(mousePressedOver(op2)){gamestate=16
          }   }
   }
if(s8===2){
   ...
   // if(keyDown("q")){t17=2}
    ...
    if(s11===2){
        ...
        if(t22===1||t22===5){ 
            ...
            if(s11===5){
                text("Well... atleast it isn't as bad as I expected. Anyways, unfortunately I cannot be of more help.",10,380)
                ...
                var op=createSprite(360,450,60,20)
                op.visible=false
                fill("yellow")
                text("Okay.",340,455)
                if(mousePressedOver(op)){s11=0
...
if(mousePressedOver(npc20)&&s17===0){
    if(t18===3){s17=7}
    if(t18!==3){s17=6}
}
if(s17===1){
...
if(s17===7){
    if(t22===5||t22===12){
     if(t18==3){
        text("We can't wait any longer. The forces are ready and we need to make a move.",10,400)
        text("Are you ready>",10,420)
        ...
        fill("yellow")
        text("No.",240,465)
        if(mousePressedOver(op1)){ s17=8} 
        if(mousePressedOver(op2)){ s17=0} 
     } 
     if(t18!==3){
        text("We need to launch the attack on Cordonia soon. You should go around and the kingdom and",10,400)
        text("make sure you're sure that you're ready.",10,420)
      //text("and tell him which of the suspected locations is the base.",10,440)
        var op=createSprite(360,440,60,20)
        op.visible=false
        fill("yellow")
...
if(s17===8){
    text("We both will be moving through a secret passage so you will have to be blindfolded.",10,400)
    text("These are mere precautions.",10,420)
  //text("and tell him which of the suspected locations is the base.",10,440)
    var op=createSprite(360,440,60,20)
    op.visible=false
    fill("yellow")
    text("Um... okay",340,445)
    if(mousePressedOver(op)){s17=0
    gamestate=26    
    }      
}
...
if(s19===2){
    text("Can you just point out the locations for me?",10,415) 
    fill("yellow")
    strokeWeight(3)
    text("(say the truth)",250,440)
    text("(lie)",400,440)
    op1=createSprite(290,440,50,20)
    op2=createSprite(420,440,50,20)
    op1.visible=false
    op2.visible=false
    if(mousePressedOver(op1)){s19=3
    path=path-1}
    if(mousePressedOver(op2)){s19=3
    path=path+1}         
}
if(s19===3){
...
if(mc.x<0){mc.x=10}
    if(mc.x>700){gamestate=18
        ...
        if(mousePressedOver(npc24)){
         s21=1  
        }
    if(s21===1){
        text("Oh hello. So you're the one who came to the castle from Cordonia. This castle is filled",10,380)
        text("with secrets. The staff knows much more than the nobles.",10,400)
        var op=createSprite(360,420,60,20)
        op.visible=false
        fill("yellow")
        text("Okay",340,425)
        if(mousePressedOver(op)){
    ...
    if(s21===2){
        fill("white")
        text("I can tell you what you want to know, but for a price.",10,400)
        text("Don't worry, I won't snitch.",10,440)
        op1=createSprite(190,420,200,20)
        op2=createSprite(190,440,200,20) 
        op3=createSprite(190,460,200,20) 
        op3.visible=false
        op1.visible=false
        op2.visible=false
        fill("yellow")
        if(q1===0){text("Do you know any of the Prince's weaknesses? (-40 coins)",50,420)
        if(mousePressedOver(op1)&&coins>39){s21=3}
        coins=coins-40 }
        if(q2===0){text("Do you know any way to get to Cordonia faster? (-40 coins)",50,440)
        if(mousePressedOver(op1)&&coins>39){s21=4} 
        coins=coins-40 }
        if(q3===0){text("Do you have any other advice for me? (-40 coins)",50,460) 
        if(mousePressedOver(op2)&&coins>39){s21=5
        coins=coins-40} }     
        //text("Do you know where I can find potion ingredients?",300,475) 
        //if(mousePressedOver(op3)){s13=4}      
        var op=createSprite(160,470,60,20)
        op.visible=false
        text("Nothing.",140,475)
        if(mousePressedOver(op)){s21=0}
    }
    if(s21===3){
        text("The Prince is allergic to bees. If you want to kill him, that will be the easiest",10,400)
        text("way. Here, I do have a bag full of bees, not on purpose of course.",10,420)
    ...
    if(s21===4){
        text("When you go to through the secret passage with the Prince, go through the left",10,400)
        text("passage. Don't ask how I know this.",10,420)
      //  text("inside. Bring it to me. He wont let you do that for obvious reasons so get rid of him first.",10,440)
        var op=createSprite(360,460,60,20)
        op.visible=false
        fill("yellow")
    ...
    if(s21===5){
        text("After you're done with the whole war thing, run away. Whaterver you do, don't come",10,400)
        text("back. Alright?",10,420)
      //  text("inside. Bring it to me. He wont let you do that for obvious reasons so get rid of him first.",10,440)
        var op=createSprite(360,460,60,20)
        op.visible=false
        fill("yellow")
...
if(s22===3){
    text("Yes, I wanted to talk to you. Who's side are you really on? And don't worry. I won't snitch.",1,415) 
    fill("yellow")
    strokeWeight(3)
    text("The Four Kingdoms.",230,440)
    text("Cordonia.",410,440)
    op1=createSprite(290,440,50,20)
    op2=createSprite(420,440,50,20)
    op1.visible=false
    op2.visible=false
...
if(s22===4){
    ...
    text(" forms of communication to Cordonia and burn it.",10,440)
    var op=createSprite(360,460,60,20)
    op.visible=false
    fill("yellow")
    text("Okay",340,465)
...
npc20.y=310;
npc20.x=400;
if(mousePressedOver(npc20)&&s27===0){
s27=1
}
if(s27===1){
    text("These caves will lead us straight to Cordonia. We have to go left now.",10,420)
    // text("Its fake anyway, but don't tell that to anyone.",10,440)
     var op1=createSprite(360,440,60,20)
         op1.visible=false
         fill("yellow")
         text("Okay.",340,445)
         if(mousePressedOver(op1)){ s27=2
            cavepath="right"
         }     
         var op2=createSprite(360,460,60,20)
         op2.visible=false
         fill("yellow")
         if(q2===1){text("Lets go left, its faster.",340,460)
         if(mousePressedOver(op2)){ s27=2
cavepath="left"
         }      } 
}
if(s27===2){
    text("Okay then.",110,380)
    text("(Last chance for being loyal to Cordonia.)",60,400)
    var op1=createSprite(260,420,60,20)
    op1.visible=false
    fill("yellow")
    text("(Stab the Prince)",200,420)
    if(mousePressedOver(op)){ s27=3
        mc.x=200
    }     
    var op2=createSprite(260,450,60,20)
    op2.visible=false
    fill("yellow")
 //   if(q1===1){
        text("(Unleash the bees)",200,450)
    if(mousePressedOver(op2)){ s27=4
       // npc20.velocityX=-7
      }    
//  }   
    var op3=createSprite(260,480,60,20)
    op3.visible=false
    fill("yellow")
    {text("(Do nothing)",200,480)
    if(mousePressedOver(op3)){ s27=5
    }      }        
}
if(s27===3){
    text("What the hell are you doing? You're a detective not a soldier.",10,400)
    text("(Handcuffs you.)",10,420)
    var op1=createSprite(260,460,60,20)
    op1.visible=false
    fill("yellow")
    text("...",240,465)
    if(mousePressedOver(op1)){ s27=0
        gamestate=28
        prince="caught"
    }         
}
if(s27===4){
    ...
    text("Where did the bees come from?",10,400)
    //text("(runs)",10,420)
    var op1=createSprite(260,460,60,20)
    op1.visible=false
    fill("yellow")
...
if(s27===5){
    text("Lets go, we're almost there.",10,400)
    //text("(Handcuffs you.)",10,420)
    var op1=createSprite(260,460,60,20)
   op1.visible=false
    fill("yellow")
...
if(gamestate===29){
    bg.changeImage("bg29",img29)
    bg.scale=1
mc.visible=true
npc7d20.visible=false
if(s29===0){
    text("(What do you want to do next?)",1,405) 
    //text("I want to ask you something. What are you going to do after this?",1,425)     
    fill("yellow")
    strokeWeight(3)
    text("Return to the Four Kingdoms.",250,460)
    text("Stay for the battle.",400,460)
    text("Go somewhere else.",250,480)
    op1=createSprite(290,440,50,20)
    op2=createSprite(420,440,50,20)
    op1.visible=false
    op2.visible=false
    op3=createSprite(420,440,50,20)
    op3.visible=false
    if(mousePressedOver(op3)){future="safe"
    gamestate=31}
    if(mousePressedOver(op1)){future="four"
    gamestate=31}
    if(mousePressedOver(op2)){future="cordonia"
    gamestate=31}     
}
}
if(gamestate===30){
    if(mc.x<10){mc.x=20}
    if(mc.x>690){mc.x=680}
    bg.changeImage("bg29",img29)
    bg.scale=1
npc20.visible=true  
mc.visible=true  
if(prince==="alive"){
if(s30===0){
    text("We're finally here. Looks like we're late. Now before we go in",1,405) 
    text("I want to ask you something. What are you going to do after this?",1,425)     
    fill("yellow")
    strokeWeight(3)
    text("Return to the Four Kingdoms.",250,460)
    text("Stay here.",400,460)
    text("Go somewhere else.",250,480)
    op1=createSprite(290,440,50,20)
    op2=createSprite(420,440,50,20)
    op1.visible=false
...
mc.x=100
if(s301===0){
    text("Looks like we're late. Was trying to kill me really worth it? Not that",10,405) 
    text("it matters now anyway.... goodbye",10,420)
    strokeWeight(3)
    text("...",250,460)
    op1=createSprite(290,440,50,20)
    op1.visible=false
    if(mousePressedOver(op1)){gamestate=31}
    }
}
}
if(gamestate===31){
...
text("After the war you are taken back to Jade City and put on trial for attempted murder of  ",10,420)
text("the Prince. You spend the rest of your days in the dungeons.",10,440)
var op=createSprite(360,460,60,20)
        op.visible=false
        text("Okay",340,465)
        if(mousePressedOver(op)){gamemode=32
                              } 
}
if(prince==="alive"){

if(future==="safe"){
    text("After the war you are rewarded with riches enough to sustain you a lifetime. You take",10,420)
    text("a boat to a faraway kingdom in the south and start a new life.",10,440)
    var op=createSprite(360,460,60,20)
            op.visible=false
            text("Okay",340,465)
            if(mousePressedOver(op)){gamemode=32
...
if(future==="four"){
    text("After the war you are rewarded with riches enough to sustain you a lifetime. But soon you",10,380)
    text("are accused of treason by the King. You are later found guilty even though you were ",10,400)
    text("innocent. You later discover you were framed but its too late by then. You spend the rest",10,420)
    text("of your days in the dungeons.",10,440)
    var op=createSprite(360,460,60,20)
            op.visible=false
            text("Okay",340,465)
            if(mousePressedOver(op)){gamemode=32
...
if(prince==="dead"){
    ...
    if(future==="safe"){
        text("You take a last look at your dying homeland, then walk to the nearest port to take",10,420)
        text("a boat to a faraway kingdom in the south and start a new life.",10,440)
        var op=createSprite(360,460,60,20)
                op.visible=false
                text("Okay",340,465)
    ...
    if(future==="four"){
        text("You take a last look at your dying homeland, then go back to Jade City. You try to convince",10,380)
        text("the people you did not murder the Prince. But since you were supposed to be with him when he",10,400)
        text("died you are proclaimed guilty and spend the rest of your days in the dungeons.",10,420)
       // text("of your days in the dungeons.",10,440)
        var op=createSprite(360,460,60,20)
                op.visible=false
                text("Okay",340,465)
    ...
    if(future==="cordonia"){
        text("You return to Cordonia and help them overpower the Four Kingdoms' forces through your secret",10,380)
        text("intel. After a long battle, Cordonia wins. There were huge losses on both sides and The Kingdoms'",10,400)
        text("promise to maintain peace fro now. Although it was hard, Cordonia finally got back up on its feet ",10,420)
        text("again, with the Queen as its leader. You live a safe and peaceful life in the castle.",10,440)
        var op=createSprite(360,460,60,20)
                op.visible=false
                text("Okay",340,465)
                if(mousePressedOver(op)){gamemode=32
...
if(gamestate===32){
    ...
    textSize(30)
    fill("white")
    text("The End",230,300) 
    textSize(18)
    text("refresh to restart",10,460)
}
} 
function move(){
